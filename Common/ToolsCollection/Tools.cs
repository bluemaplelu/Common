...
namespace ECS.Common.ToolsCollection
{
    ...
    public static class Tools
    {
        ...
        public static bool IsIP(string ip)
        {
            ...
            //验证
            return DotNet.Utilities.RegexHelper.IsMatch(ip, pattern);
        }
        #endregion
        ...
        public static bool IsEmail(string email)
        {
            ...
            //验证
            return DotNet.Utilities.RegexHelper.IsMatch(email, pattern);
        }
        #endregion
        ...
        public static bool IsInt(string number)
        {
            ...
            //验证
            return DotNet.Utilities.RegexHelper.IsMatch(number, pattern);
        }
        #endregion
        ...
        public static bool IsIdCard(string idCard)
        {
            ...
            //验证
            return DotNet.Utilities.RegexHelper.IsMatch(idCard, pattern.ToString());
        }
        #endregion
